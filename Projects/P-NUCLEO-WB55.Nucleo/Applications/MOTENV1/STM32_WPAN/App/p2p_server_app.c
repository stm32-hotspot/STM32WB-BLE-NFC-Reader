...
//        HAL_GPIO_WritePin(LED_RED_GPIO_Port, LED_RED_Pin, GPIO_PIN_SET);      //[STM] - Free LED_RED_Pin
      }
      else {
//        HAL_GPIO_WritePin(LED_RED_GPIO_Port, LED_RED_Pin, GPIO_PIN_RESET);    //[STM] - Free LED_RED_Pin
      }
