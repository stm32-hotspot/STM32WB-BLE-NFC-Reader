...
/*!
 *****************************************************************************
 * Dump a Handover Collision Resolution type
 *
 * \param[in] cr: Collision Resolution to dump
 *
 * \return ERR_NONE if successful or a standard error code
 *****************************************************************************
 */
ReturnCode ndefHandoverCrDump(const ndefType* cr);

/*!
 *****************************************************************************
 * Dump a Handover Alternative Carrier type
 *
 * \param[in] ac: Alternative Carrier to dump
 *
 * \return ERR_NONE if successful or a standard error code
 *****************************************************************************
 */
ReturnCode ndefHandoverAcDump(const ndefType* ac);

/*!
 *****************************************************************************
 * Dump a Handover Error type
 *
 * \param[in] err: Error to dump
 *
 * \return ERR_NONE if successful or a standard error code
 *****************************************************************************
 */
ReturnCode ndefHandoverErrDump(const ndefType* err);

/*!
 *****************************************************************************
 * Dump a Handover type
 *
 * \param[in] handover: Handover type to dump, may contain nested types
 *
 * \return ERR_NONE if successful or a standard error code
 *****************************************************************************
 */
ReturnCode ndefHandoverDump(const ndefType* handover);

/*!
 *****************************************************************************
 * Dump a Handover Carrier type
 *
 * \param[in] cr: Collision Resolution to dump
 *
 * \return ERR_NONE if successful or a standard error code
 *****************************************************************************
 */
ReturnCode ndefHandoverCarrierDump(const ndefType* hc);
